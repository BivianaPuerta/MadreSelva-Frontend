  ...
  const formik = useFormik({
      ...
      onSubmit: datos => {
          Swal.fire({
              ...
              confirmButtonText: 'Desea crear este Producto'
            }).then((result) => {
              if (result.isConfirmed) {
                  try{ console.log(datos);
                      fetch(`http://localhost:8080/api/cosmetics/new`, {
                          method: "POST",
      ...
      <h1 className="text-3xl font-light mb-4">Agregar productos</h1>
           <div className="flex justify-center mt-10">
                <div className="w-full max-w-3xl">
                   ...
                   <input
                            type="submit"
                            className="bg-gray-800 hover:bg-green-700 w-full mt-5 p-2 text-white uppercase font-bold"
